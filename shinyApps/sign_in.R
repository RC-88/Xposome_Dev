      ...
      fluidRow(
        ...
        column(
          ...
          conditionalPanel(
            ...
            ##REDO ANALYSIS####
            radioButtonsWithTooltip(inputId="edit_Analysis", label="Redo Analysis", bId="edit_analysis_tooltip", helptext="some helptext here", choices=c("Yes", "No"), selected="Yes", inline=TRUE),            
